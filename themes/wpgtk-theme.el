...
(defun get-hex-or-term (n)
  ...
  (cond ((eq n 0)  (if (display-graphic-p) "#211b16"  "black"))
        ((eq n 1)  (if (display-graphic-p) "#A86645"  "red"))
        ((eq n 2)  (if (display-graphic-p) "#356E53"  "green"))
        ((eq n 3)  (if (display-graphic-p) "#BB9951"  "yellow"))
        ((eq n 4)  (if (display-graphic-p) "#897198"  "blue"))
        ((eq n 5)  (if (display-graphic-p) "#469750"  "magenta"))
        ((eq n 6)  (if (display-graphic-p) "#576055"  "cyan"))
        ((eq n 7)  (if (display-graphic-p) "#d5d5ba"  "white"))
        ((eq n 8)  (if (display-graphic-p) "#392e25"  "brightblack"))
        ((eq n 9)  (if (display-graphic-p) "#e97f4a"  "brightred"))
        ((eq n 10) (if (display-graphic-p) "#3a996c" "brightgreen"))
        ((eq n 11) (if (display-graphic-p) "#ffcd57" "brightyellow"))
        ((eq n 12) (if (display-graphic-p) "#b681d6" "brightblue"))
        ((eq n 13) (if (display-graphic-p) "#4cd25d" "brightmagenta"))
        ((eq n 14) (if (display-graphic-p) "#698862" "brightcyan"))
        ((eq n 15) (if (display-graphic-p) "#ffffed" "brightwhite"))))
...
;;;;; org
     ...
     `(org-level-1 ((,class (:bold t :foreground ,inf :height ,(if wpgtk-theme-org-height 1.3 1.0) :background ,org-h1-bg :overline t))))
