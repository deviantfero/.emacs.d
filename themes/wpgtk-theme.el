...
(defun get-hex-or-term (n)
  ...
  (cond ((eq n 0)  (if (display-graphic-p) "#efe6d4"  "black"))
        ((eq n 1)  (if (display-graphic-p) "#b96949"  "red"))
        ((eq n 2)  (if (display-graphic-p) "#5ec9a4"  "green"))
        ((eq n 3)  (if (display-graphic-p) "#9e95a7"  "yellow"))
        ((eq n 4)  (if (display-graphic-p) "#b1875c"  "blue"))
        ((eq n 5)  (if (display-graphic-p) "#bcb221"  "magenta"))
        ((eq n 6)  (if (display-graphic-p) "#c4687d"  "cyan"))
        ((eq n 7)  (if (display-graphic-p) "#2e2924"  "white"))
        ((eq n 8)  (if (display-graphic-p) "#d4ccbc"  "brightblack"))
        ((eq n 9)  (if (display-graphic-p) "#973f1c"  "brightred"))
        ((eq n 10) (if (display-graphic-p) "#28a67a" "brightgreen"))
        ((eq n 11) (if (display-graphic-p) "#6e4c90" "brightyellow"))
        ((eq n 12) (if (display-graphic-p) "#935e29" "brightblue"))
        ((eq n 13) (if (display-graphic-p) "#968d04" "brightmagenta"))
        ((eq n 14) (if (display-graphic-p) "#a32e49" "brightcyan"))
        ((eq n 15) (if (display-graphic-p) "#010101" "brightwhite"))))
...
;;;;; header-line
     `(header-line           ((,class (:foreground ,bg1 :background ,active1 :box (:color ,m-line-brdr :line-width 0)))))
