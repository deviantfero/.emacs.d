...
(defun get-hex-or-term (n)
  ...
  (cond ((eq n 0)  (if (display-graphic-p) "#271f27"  "black"))
        ((eq n 1)  (if (display-graphic-p) "#D8764C"  "red"))
        ((eq n 2)  (if (display-graphic-p) "#596a46"  "green"))
        ((eq n 3)  (if (display-graphic-p) "#a6a764"  "yellow"))
        ((eq n 4)  (if (display-graphic-p) "#588886"  "blue"))
        ((eq n 5)  (if (display-graphic-p) "#959595"  "magenta"))
        ((eq n 6)  (if (display-graphic-p) "#6cccc8"  "cyan"))
        ((eq n 7)  (if (display-graphic-p) "#b3b3ba"  "white"))
        ((eq n 8)  (if (display-graphic-p) "#3d303d"  "brightblack"))
        ((eq n 9)  (if (display-graphic-p) "#ff914f"  "brightred"))
        ((eq n 10) (if (display-graphic-p) "#74954f" "brightgreen"))
        ((eq n 11) (if (display-graphic-p) "#e8ea70" "brightyellow"))
        ((eq n 12) (if (display-graphic-p) "#63bfbb" "brightblue"))
        ((eq n 13) (if (display-graphic-p) "#d4aeae" "brightmagenta"))
        ((eq n 14) (if (display-graphic-p) "#78ffff" "brightcyan"))
        ((eq n 15) (if (display-graphic-p) "#ededf7" "brightwhite"))))
